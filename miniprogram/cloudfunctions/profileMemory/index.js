...
function aiPrompt(sources) {
  ...
  return [
    ...
    'summary 是一段连续的话，约150-200字，不分栏、不加小标题、不列清单。它要回答的是「这个人是怎样的」，不是「这个人最近梦见了什么」。整体替换旧画像，不能追加或逐条复述素材。',
    ...
    '说倾向，不说清单：意象是原料不是结论，不得罗列意象词，不得复述梦境场景，不得出现梦的条数、次数或任何使用统计——那是系统的视角，不是这个人的样子。从梦境推断出来的倾向可以写，但只写推断结果，不铺垫原始场景作为佐证。',
