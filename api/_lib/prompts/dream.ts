...
- "image_prompt" 只筛选1个主事件、最多1个异常规则、2-4个关键元素；必须写明主情绪、动态高饱和配色、不对称构图与35%-50%留白，不得逐项罗列所有名词，不得默认蓝色或紫色。
...

{
  ...
  "image_prompt": "英文视觉规划摘要：主事件、主情绪与强度、2-4个关键元素、最多1个异常规则、主体偏置、视觉动线、35%-50%留白、4-6色动态情绪配色，不超过100词",
  "omens": {
    "lucky_color": "#hexcode",
